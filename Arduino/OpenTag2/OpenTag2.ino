...
int recDur = 300;
int recInt = 0;
int LED_REDen = 1; //enable green LEDs flash 1x per second. Can be disabled from script.
...
void fileInit()
{
   ...
   dataFile.println("accelX,accelY,accelZ,magX,magY,magZ,datetime,red,green,blue,pressure(mBar),temperature,latitude,latHem,longitude,lonHem,V");
   SdFile::dateTimeCallback(file_date_time);
   Serial.println(filename);
}
