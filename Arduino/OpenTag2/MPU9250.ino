...
int mpuInit(boolean mode)
{
   ...
   if(mode==0)
  {
    ...
    SerialUSB.println("Accelerometer scale");
...
void readImu(byte reg)
{
  int i = 0;
  Wire.beginTransmission(GyroAddress); 
  Wire.write(reg);        //sends address to read from  0x3B is direct read; 0x74 is FIFO
